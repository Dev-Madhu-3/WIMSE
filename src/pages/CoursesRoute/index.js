...
const CoursesRoute = () => {
    ...
    return (
        <main className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-900 to-purple-900 text-white py-16 max-sm:py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            {/* Background Pattern */}
                ...
                >
                    ...
                    >
                        ...
                        <AnimatePresence>
                            {isDropdownOpen && (
                                <motion.div 
                                    className="absolute left-0 mt-2 min-w-64 bg-slate-800/90 backdrop-blur-lg border border-slate-700/50 rounded-xl shadow-xl z-50 overflow-hidden"
                    ...
                    >
                        <div className="relative">
                            <input
                                ...
                                className="w-full py-4 pl-14 pr-12 rounded-2xl bg-slate-800/70 backdrop-blur-lg border border-slate-700/50 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent shadow-lg"
                                value={searchQuery}
                        ...
                        {filteredCourses.flatMap(each =>
                            each.specializations.map((course, index) => (
                                ...
                                >
                                    ...
                                    {/* Content Section */}
                                    <motion.div 
                                        className="w-full max-sm:w-full md:w-3/5 lg:w-3/5 bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-lg rounded-2xl p-6 max-sm:p-5 md:p-8 border border-slate-700/30 shadow-xl"
                                        whileHover={{ y: -5 }}
                                        transition={{ duration: 0.4 }}
                                    >
                                        <div className="flex items-start gap-4 mb-6">
                                            ...
                                            <div className="flex-1">
                                                <h3 className="text-xl max-sm:text-lg md:text-2xl lg:text-2xl font-bold mb-2 text-white">{course.name}</h3>
                                                <div className="flex flex-wrap items-center gap-3">
                                                    <span className="px-3 py-1 bg-cyan-900/50 rounded-full text-sm text-cyan-300 flex items-center gap-1">
                                                        <FaGraduationCap />
                                                        Online & Offline
                                                    </span>
                                                    {renderStars()}
                                        ...
                                        <p className="text-slate-300 mb-6 leading-relaxed text-base max-sm:text-sm md:text-base">
                                            {course.description}
                                        </p>
                                        ...
                                        {course.duration && (
                                            <div className="flex flex-wrap gap-4 mb-8">
                                                <div className="flex items-center gap-2 bg-indigo-900/50 px-4 py-2 rounded-lg border border-indigo-700/30">
                                                    ...
                                                    <span className="text-sm md:text-base text-slate-200">{course.duration} Years</span>
                                                </div>
                                                <div className="flex items-center gap-2 bg-purple-900/50 px-4 py-2 rounded-lg border border-purple-700/30">
                                                    ...
                                                    <span className="text-sm md:text-base text-slate-200">{course.semester} Semesters</span>
                                                </div>
                                            </div>
                                        )}
